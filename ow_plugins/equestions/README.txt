OXPro Extended Questions allow users to get answers to their queries from other users on the site.
...
Asking a Question
	...
	Enter a question, and click Add Poll Options if you'd like to give options.
            If you want you can add some media to the question like picture, video or external link
            If you want to allow others to add options too, make sure the Allow anyone to add options box is checked.
...
To suggest a question to other users click Ask Friend/User button and select users from list. And users will be notified.
