...
define('OW_URL_HOME', 'http://baksmaker.com/fulfill/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'agilekod_fulfill');
define('OW_DB_PASSWORD', 'fulfill');
define('OW_DB_NAME', 'agilekod_fulfill');
...
define('OW_PASSWORD_SALT', '53499e287b6e6');
