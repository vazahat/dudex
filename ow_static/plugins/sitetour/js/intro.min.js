(function(q, e) {
    ...
    function e(b) {
        ...
        this._options = {nextLabel: "Next &rarr;", prevLabel: "&larr; Back", skipLabel: "Skip", doneLabel: "Done", tooltipPosition: "bottom", tooltipClass: "", exitOnEsc: !0, exitOnOverlayClick: !0, showStepNumbers: !0, keyboardNavigation: !0, showButtons: !0, showBullets: !0}
    }
    function v() {
        "undefined" === typeof this._currentStep ? this._currentStep = 0 : ++this._currentStep;
        if (this._introItems.length <= this._currentStep)
            "function" === typeof this._introCompleteCallback && this._introCompleteCallback.call(this), s.call(this, this._targetElement);
        else {
    ...
    function s(b) {
        ...
        if (b = document.querySelector(".introjs-showElement"))
        ...
        if ((b = document.querySelectorAll(".introjs-fixParent")) && 0 < b.length)
            for (var c = b.length - 1; 0 <= c; c--)
                b[c].className = b[c].className.replace(/introjs-fixParent/g,
                        "").replace(/^\s+|\s+$/g, "");
    ...
    function y(b, a, c) {
        ...
        if (this._introItems[this._currentStep]) {
            var d = "", d = this._introItems[this._currentStep], d = "string" === typeof d.tooltipClass ? d.tooltipClass : this._options.tooltipClass;
    ...
    function w(b) {
        if (b && this._introItems[this._currentStep]) {
            ...
            b.setAttribute("style", "width: " + (a.width + 10) + "px; height:" + (a.height + 10) + "px; top:" + (a.top - 5) + "px;left: " + (a.left - 5) + "px;")
        }
    }
    function t(b) {
        var a;
        ...
        p(b.element);
        if (null != d) {
            var f = d.querySelector(".introjs-helperNumberLayer"), A = d.querySelector(".introjs-tooltiptext"), h = d.querySelector(".introjs-arrow"),
                    n = d.querySelector(".introjs-tooltip"), g = d.querySelector(".introjs-skipbutton"), m = d.querySelector(".introjs-prevbutton"), j = d.querySelector(".introjs-nextbutton");
            n.style.opacity = 0;
            w.call(c, d);
            var k = document.querySelectorAll(".introjs-fixParent");
            if (k && 0 < k.length)
                for (a = k.length - 1; 0 <= a; a--)
                    k[a].className = k[a].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
            ...
            var g = document.createElement("div"), k = document.createElement("div"), l = document.createElement("div"), m = document.createElement("div"),
                    j = document.createElement("div"), e = document.createElement("div");
        ...
        for (a = b.element.parentNode; null != a && "body" !== a.tagName.toLowerCase(); )
            k = z(a, "z-index"), /[0-9]+/.test(k) && (a.className += " introjs-fixParent"), a = a.parentNode;
    ...
    function B(b) {
        var a = document.createElement("div"), c = "", d = this;
        a.className = "introjs-overlay";
        if ("body" === b.tagName.toLowerCase())
            c += "top: 0;bottom: 0; left: 0;right: 0;position: fixed;", a.setAttribute("style", c);
        else {
            var f = p(b);
    ...
    function p(b) {
        ...
        for (var c = 0, d = 0; b && !isNaN(b.offsetLeft) && !isNaN(b.offsetTop); )
    ...
    u.version = "0.6.0";
    u.fn = e.prototype = {clone: function() {
            return new e(this)
        }, setOption: function(b, a) {
            this._options[b] = a;
            return this
        }, setOptions: function(b) {
            var a = this._options, c = {}, d;
            for (d in a)
                c[d] = a[d];
            for (d in b)
                c[d] = b[d];
            ...
            a:{
                ...
                if (this._options.steps)
                    ...
                    for (e = d.length; f < e; f++) {
                        var h = d[f], n = parseInt(h.getAttribute("data-step"), 10);
                        0 < n && (a[n - 1] = {element: h, intro: h.getAttribute("data-intro"), step: parseInt(h.getAttribute("data-step"), 10), tooltipClass: h.getAttribute("data-tooltipClass"),
                            position: h.getAttribute("data-position") || this._options.tooltipPosition})
                    }
                    f = n = 0;
                    for (e = d.length; f < e; f++)
                        if (h = d[f], null == h.getAttribute("data-step")) {
                            for (; "undefined" != typeof a[n]; )
                                n++;
                            a[n] = {element: h, intro: h.getAttribute("data-intro"), step: n + 1, tooltipClass: h.getAttribute("data-tooltipClass"), position: h.getAttribute("data-position") || this._options.tooltipPosition}
                        }
                }
                f = [];
                ...
                B.call(c, b) && (v.call(c),
                    ...
                    if (27 === a.keyCode && !0 == c._options.exitOnEsc)
                        s.call(c, b), void 0 != c._introExitCallback && c._introExitCallback.call(c);
                    else if (37 === a.keyCode)
                        x.call(c);
                    else if (39 === a.keyCode || 13 === a.keyCode)
                        v.call(c), a.preventDefault ? a.preventDefault() : a.returnValue = !1
