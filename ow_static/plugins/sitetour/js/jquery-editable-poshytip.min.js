...
!function(a) {
    ...
    b.prototype = {constructor: b, initInput: function() {
            ...
            if ("object" === a.type(d) && void 0 !== d.newValue) {
                ...
                return this.error(d), this.showForm(), void 0;
            ...
            this.isSaving = !0, a.when(this.save(e)).done(a.proxy(function(a) {
                ...
                return b === !1 ? (this.error(!1), this.showForm(!1), void 0) : "string" == typeof b ? (this.error(b), this.showForm(), void 0) : (b && "object" == typeof b && b.hasOwnProperty("newValue") && (c = b.newValue), this.error(!1), this.value = c, this.$div.triggerHandler("save", {newValue: c, submitValue: e, response: a}), void 0)
        ...
        switch (c) {
            ...
            case"submit":
                ...
                if (a.isEmptyObject(i)) {
                    var j = {};
                    if (1 === h.length) {
                        var k = h.data("editable"), l = {name: k.options.name || "", value: k.input.value2submit(k.value), pk: "function" == typeof k.options.pk ? k.options.pk.call(k.options.scope) : k.options.pk};
    ...
    "use strict";
    if (a.extend(a.fn.editableContainer.Popup.prototype, {containerName: "poshytip", innerCss: "div.tip-inner", defaults: a.fn.poshytip.defaults, initContainer: function() {
            this.handlePlacement(), a.extend(this.containerOptions, {showOn: "none", content: "", alignTo: "target"}), this.call(this.containerOptions)
        }, show: function(b) {
            this.$element.addClass("editable-open"), b !== !1 && this.closeOthers(this.$element[0]), this.$form = a("<div>"), this.renderForm();
            var c = a("<label>").text(this.options.title || this.$element.data("title") || this.$element.data("originalTitle")), d = a("<div>").append(c).append(this.$form);
            ...
            a.extend(this.containerOptions, {alignX: b, offsetX: d, alignY: c, offsetY: e})
        }}), a.fn.editableContainer.defaults = a.extend({}, a.fn.editableContainer.defaults, {className: "tip-yellowsimple"}), a.Poshytip) {
        var b = /^url\(["']?([^"'\)]*)["']?\);?$/i, c = /\.png$/i, d = !!window.createPopup && "undefined" == document.documentElement.currentStyle.minWidth;
            ...
            if (!this.disabled) {
                ...
                if (e) {
                    if (!this.$tip.data("active"))
                        return;
                    f = {left: this.$tip.css("left"), top: this.$tip.css("top")}
                }
                this.$tip.css({left: 0, top: 0}).appendTo(document.body), void 0 === this.opacity && (this.opacity = this.$tip.css("opacity"));
                var g = this.$tip.css("background-image").match(b), h = this.$arrow.css("background-image").match(b);
                if (g) {
                    var i = c.test(g[1]);
                    d && i ? (this.$tip.css("background-image", "none"), this.$inner.css({margin: 0, border: 0, padding: 0}), g = i = !1) : this.$tip.prepend('<table class="fallback" border="0" cellpadding="0" cellspacing="0"><tr><td class="tip-top tip-bg-image" colspan="2"><span></span></td><td class="tip-right tip-bg-image" rowspan="2"><span></span></td></tr><tr><td class="tip-left tip-bg-image" rowspan="2"><span></span></td><td></td></tr><tr><td class="tip-bottom tip-bg-image" colspan="2"><span></span></td></tr></table>').css({border: 0, padding: 0, "background-image": "none", "background-color": "transparent"}).find(".tip-bg-image").css("background-image", 'url("' + g[1] + '")').end().find("td").eq(3).append(this.$inner), i && !a.support.opacity && (this.opts.fade = !1)
                }
                ...
                if (d) {
                    ...
                    var k = this.$tip.width(), l = parseInt(this.$tip.css("min-width"), 10), m = parseInt(this.$tip.css("max-width"), 10);
                    !isNaN(l) && l > k ? k = l : !isNaN(m) && k > m && (k = m), this.$tip.add(j).width(k).eq(0).find("td").eq(3).width("100%")
                } else
                    j[0] && j.width("auto").find("td").eq(3).width("auto").end().end().width(document.defaultView && document.defaultView.getComputedStyle && parseFloat(document.defaultView.getComputedStyle(this.$tip[0], null).width) || this.$tip.width()).find("td").eq(3).width("100%");
                if (this.tipOuterW = this.$tip.outerWidth(), this.tipOuterH = this.$tip.outerHeight(), this.calcPos(), h && this.pos.arrow && (this.$arrow[0].className = "tip-arrow tip-arrow-" + this.pos.arrow, this.$arrow.css("visibility", "inherit")), e) {
                    ...
                    var n = this;
                    this.$tip.css(f).animate({left: this.pos.l, top: this.pos.t}, 200, function() {
                        n.asyncAnimating = !1
                    })
                } else
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {initPicker: function(b, c) {
        ...
        }}), b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, {tpl: '<div class="editable-date"></div>', inputclass: null, format: "yyyy-mm-dd", viewformat: null, datepicker: {firstDay: 0, changeYear: !0, changeMonth: !0, showOtherMonths: !0}, clear: "&times; clear"}), a.fn.editabletypes.dateui = b
}(window.jQuery), function(a) {
    "use strict";
    var b = function(a) {
        this.init("dateuifield", a, b.defaults), this.initPicker(a, b.defaults)
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.dateui), a.extend(b.prototype, {render: function() {
        ...
        }}), b.defaults = a.extend({}, a.fn.editabletypes.dateui.defaults, {tpl: '<input type="text"/>', inputclass: null, datepicker: {showOn: "button", buttonImage: "http://jqueryui.com/resources/demos/datepicker/images/calendar.gif", buttonImageOnly: !0, firstDay: 0, changeYear: !0, changeMonth: !0, showOtherMonths: !0}, clear: !1}), a.fn.editabletypes.dateuifield = b
}(window.jQuery);